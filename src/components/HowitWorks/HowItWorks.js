...
import "./work.css"
import Line1 from "../../assests/img-2.0/line1.png"
import Line2 from "../../assests/img-2.0/line2.png"
import Arrow1 from "../../assests/img-2.0/arrow1.png"
import Arrow2 from "../../assests/img-2.0/arrow2.png"
import Ecllipse from "../../assests/img-2.0/Ellipse .png"
    ...
    return (
     ...
     <div className='feature-sec-underline'/>
            <div className='step1'>
                ...
                <div className='step-desc'>Download the app, signup using mobile number & Submit KYC.</div>
            </div>
            <div className='step2'>
            <div style={{display:'flex'}}>
                ...
                <div className='step-desc'>Import existing wallets & exchange accounts; Manage your crypto portfolio in single place</div>
            ...
            <div style={{display:'flex'}}>
                ...
                <div className='step-desc'>Buy crypto with your favourite payment system. Earn with your HODLings. Do the Crypto to Fiat transfer & Crypto to Crypto transfer to anyone.</div>
